...
\HRule \\[0.4cm]
\textcolor{blue}{ \LARGE \bfseries Ask-Jade: End-to-End Ingestion and Vectorization Pipeline with RAG Agent for PPP Knowledge Retrieval}\\[0.4cm] % Title of your document
\HRule \\[1cm]

\vskip0.1cm%
\textit{By}\\
\textsc{\large Yessmine Hassad and Ifraj Ouni}\\[0.5cm] % Minor heading
\vskip0.2cm%
...
Aymen HERZI, SOFRECOM\\
Afif BEN BEKRI, Teacher, ISTIC\\
Imen Hamrouni, Teacher, ISTIC\\
Khaled Amri, Engineer, VERMEG\\
Asma NAJJAR, Teacher, ISTIC
\end{minipage}
